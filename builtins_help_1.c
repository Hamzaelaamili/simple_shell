...
/**
 * help_all the Displays all possible builtin shellby commands.
 */
void help_all(void)
{
...
/**
 * help_alias the Displays information on the shellby builtin command 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_cd the Displays information on the shellby builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit the Displays information on the shellby builtin command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help the Displays information on the shellby builtin command 'help'.
 */
void help_help(void)
{
